...
2) Go to the `Data Science Projects` section and access your application's project named `test-ns`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `test-sept9-1-notebook`.
...
5) In the terminal, run `cd test-sept9-1` to navigate to your sample app's directory.
