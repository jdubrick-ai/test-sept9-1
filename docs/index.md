...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-sept9-1](https://github.com/jdubrick-ai/test-sept9-1)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-sept9-1-gitops](https://github.com/jdubrick-ai/test-sept9-1-gitops)

# **Usage**

To access the test-sept9-1 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of test-ns. You can access this namespace through the web console or via your CLI.
